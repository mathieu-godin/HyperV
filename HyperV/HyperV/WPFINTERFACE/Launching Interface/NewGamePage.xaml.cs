...
namespace Launching_Interface
{
   ...
   {
      const int NBRE_FICHIERS_SAVES = 3;
      ...
      public NewGamePage()
      {
         ...
         InitializeComponent();
         OrganiserLangueEtMarges();
         PlaceContent();
         OrganiserMargesCaractéristiques();
      }

      void OrganiserLangueEtMarges()
      {
      ...
      {
         for (int i = 0; i < NBRE_FICHIERS_SAVES; ++i)
         {
      ...
      private void CreateRows(int i)
      {
         ...
         switch (i)
         {
            case 0:
               ...
               Level0.Text= LangueOficielleNewPage[4] + " " + GererDonnees.NombreNiveaux(i) + "/" + GererDonnees.NombreNiveaux(i).ToString();
            ...
            case 1:
               ...
               Level1.Text= LangueOficielleNewPage[4] + " " + GererDonnees.NombreNiveaux(i) + "/" + GererDonnees.NombreNiveaux(i).ToString();
            ...
            case 2:
               ...
               Level2.Text= LangueOficielleNewPage[4] + " " + GererDonnees.NombreNiveaux(i) + "/" + GererDonnees.NombreNiveaux(i).ToString();
      ...
      void ChangeBorderBrushColor(int i)
      {
         ...
         {
            case 0:
                    Save0Button.BorderBrush = Brushes.Black;
               break;
            case 1:
                    Save1Button.BorderBrush = Brushes.Black;
               break;
            case 2:
                    Save2Button.BorderBrush = Brushes.Black;
               break;
         }
      }
